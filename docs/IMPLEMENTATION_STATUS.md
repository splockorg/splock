...
| **README stage table** (§4.14) | **stale.** `README.md` lists `/wrap` as a lifecycle stage; there is no `commands/wrap.md` and `bin/wrap` is not a stage. Corrected in `VISION.md` §5, **not yet in README** |
